...
const NotFound: React.FC = () => (
  <div className="flex flex-col items-center justify-center h-screen bg-gray-100 text-center">
    <h1 className="text-3xl md:text-4xl font-extrabold mb-4 text-card-foreground">Page Not Found</h1>
    ...
    <h2 className="text-lg md:text-xl font-bold mb-2 text-card-foreground">Page Not Found</h2>
