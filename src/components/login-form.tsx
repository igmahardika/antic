...
export function LoginForm({
	...
	return (
		<div className={cn("flex flex-col gap-8 w-full", className)} {...props}>
			{!hideTitle && (
				<>
					<h1 className="text-2xl md:text-3xl font-extrabold text-center text-gray-900 dark:text-white tracking-tight">
						Login to your account
					</h1>
					<p className="text-center text-gray-500 dark:text-gray-400 text-base font-medium -mt-2 mb-2">
						{description || "Masuk ke dashboard Insight Ticket"}
					</p>
				</>
			)}
          ...
          />
				...
				{error && (
					<div className="text-red-500 text-center font-semibold text-sm -mt-2">
						{error}
					</div>
				)}
				<Button
