...
const MigrationPanel: React.FC = () => {
  ...
  const handleMigration = async () => {
    ...
    try {
      ...
      setSuccess('Migration completed successfully! All data has been moved to MySQL.');
      setProgress(null);
    ...
    return (
      <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6">
        ...
        <div className="flex items-center justify-center py-8">
          ...
          <span className="ml-3 text-gray-600 dark:text-gray-300">Checking migration status...</span>
        </div>
      </div>
    );
  }
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                    <p>You have data in IndexedDB that needs to be migrated to MySQL. Click the button below to start the migration process.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                    <p>No migration needed. Your application is using MySQL database.</p>
                  </div>
                </div>
              </div>
            </div>
